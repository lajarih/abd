...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MahmoudM5/7oda/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1593178008,1312558822,1499701425,1472286953}   
...
var = true  
elseif tonumber(user_id) == tonumber(1312558822) then
var = true  
elseif tonumber(user_id) == tonumber(1499701425) then
var = true
elseif tonumber(user_id) == tonumber(1472286953) then
var = true
...
os.execute('wget https://raw.githubusercontent.com/MahmoudM5/7oda/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ⚝ تم تحديث السورس \n ⚝ لديك اخر اصدار لسورس فاست\n ⚝ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ⚝' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⚝ اصدار سورس فاست \n ⚝ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⚝' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⚝ [تحديثات البوت](t.me/barotlop) \n ⚝ [قناه السورس](t.me/otlop12)')
end
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⚝ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'otlop12')..') \n ⚝ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⚝ العضو : {["..data.first_name_.."](T.ME/otlop12)}\n ⚝ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⚝ عذرا » {["..data.first_name_.."](T.ME/otlop12)}\n ⚝ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
    𝚂𝙾𝚄𝚁𝙲𝙴 Test 𖤐
▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
么  [𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗛 𓏴](t.me/otlop12) 
么  [𝗧𝗢𝗣 𖤐](t.me/xxmeanxx)
么  [𝐌𝐀𝐇𝐌𝐎𝐔𝐃 𖤐](t.me/MahmoudM2)
么  [𝚃𝚆𝚂 𖤐](t.me/Meui1bot)
▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⚝ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'otlop12')..') \n ⚝ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⚝ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'otlop12')..') \n ⚝ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MahmoudM5/7oda/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⚝ اهلا بك في متجر ملفات فاست\n ⚝ ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n ⚝ علامة تعني { ✓ } ملف مفعل\n ⚝ علامة تعني { ✘ } ملف معطل\n ⚝ قناة سورس فاست ↓\n".." ⚝ [اضغط هنا لدخول](t.me/otlop12) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MahmoudM5/7oda/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_," ⚝ عذرا الملف لايدعم سورس فاست \n") 
end
return false
end
...
if text == ("") and msg.reply_to_message_id_ and CoSu(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⚝ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'otlop12')..')'
status  = '\n ⚝ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⚝ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⚝ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'otlop12')..')'..'\n ⚝ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاست').."" then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'otlop12')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' ⚝ تم طردك بنجاح من الروم ياريت تاخد الباب ف ايدك 😹😒') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' ⚝ تم تعطيل امر اطردني اترزع هنا مش هتخرج 😹🌚') 
end
end
...
send(msg.chat_id_, msg.id_,' ⚝ انت دخلت بنفسك محدش ضافك 😹🙂') 
end
end,nil)
else
...
Text = '\n ⚝ تم تعطيل امر اطردني اترزع هنا مش هتخرج 😹🌚'
else
...
local amira = {
" ⚝ قمر ياروحي ❤️🥺",
" ⚝ غير الصوره اللي عفنت دي 🙂",
" ⚝ عرفنا انك عسل خلاص بقي 🤷‍♂️🥱",
" ⚝ يتي القمر نزل الارض يعمل اي🙈🥺",
" ⚝ انا دوخت من حلاوه الصوره 🥺❤️",
" ⚝ اومال لو صورتك حلوه كنت عملت اي 😂️",
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فاست')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..'اي رأيك ف دا يا' and tonumber(msg.reply_to_message_id_) > 0 then     
